...
const providers: { [k: string]: { cat: string; cost: string } } = {
  "1": {
    cat: "Below Ksh. 500, 000 upto 15 Years ",
    cost: "38, 000",
  },
  "2": {
    cat: "Below Ksh. 500, 000 upto 16 - 20 Years ",
    cost: "38, 000",
  },
  "3": {
    cat: "Above Ksh. 500, 000 upto 15 Years ",
    cost: "38, 000",
  },
  "4": {
    cat: "Above Ksh. 500, 000 upto 16 - 20 Years ",
    cost: "40, 000",
  },
};
const Page = ({ params: { val } }: { params: { val: string } }) => {
  ...
  if (!provider) {
    return (
      <div className="w-full flex-1 bg-slate-200 flex justify-center items-center flex-col  px-2 py-2 sm:px-24 sm:py-4">
        ...
        <Link href={"/service/lorries/comprehensive/trident"} className="my-6 py-4 px-6 text-white bg-[#007A37]">
          Go Back Home
        </Link>
      </div>
    );
  ...
  const handleSendEmail = async (e: FormEvent<HTMLFormElement>) => {
    ...
    const msg = `<p>Dear Admin</p></br>
                  ...
                  <ol>
                    <li>Service Name: <b>${"Lorries"}</b></li>
                    <li>Category: <b>${category}</b></li>
                    <li>Value of the Lorry: <b>${provider.cat}</b></li>
