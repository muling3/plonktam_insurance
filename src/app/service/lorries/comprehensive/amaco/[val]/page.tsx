...
const providers: { [k: string]: { cat: string; cost: string } } = {
  "1": {
    cat: "Below Ksh. 500, 000(MANDATORY EVALUATION)",
    cost: "45, 000",
  },
  "2": {
    cat: "Ksh. 500, 000 To Ksh. 1M ",
    cost: "50, 000",
  },
  "3": {
    cat: "Over Ksh. 2.5M ",
  ...
  if (!provider) {
    return (
      <div className="w-full flex-1 bg-slate-200 flex justify-center items-center flex-col  px-2 py-2 sm:px-24 sm:py-4">
        ...
        <Link href={"/service/lorries/comprehensive/amaco"} className="my-6 py-4 px-6 text-white bg-[#007A37]">
          Go Back Home
        </Link>
      </div>
    );
