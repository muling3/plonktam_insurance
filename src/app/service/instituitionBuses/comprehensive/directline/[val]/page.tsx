...
const providers: { [k: string]: { cat: string; cost: string } } = {
  "1": {
    cat: "All school buses and Vans Minimum Value Ksh. 750, 000",
    cost: "4.5% of the value of the Vehicle",
  },
};
  ...
  if (!provider) {
    return (
      <div className="w-full flex-1 bg-slate-200 flex justify-center items-center flex-col  px-2 py-2 sm:px-24 sm:py-4">
        ...
        <Link href={"/service/instituitionBuses/comprehensive/directline"} className="my-6 py-4 px-6 text-white bg-[#007A37]">
          Go Back Home
        </Link>
      </div>
    );
