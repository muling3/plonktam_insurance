...
const providers: { [k: string]: { cat: string; cost: string } } = {
  "1": {
    cat: "1 To 9 Passengers",
    cost: "6, 500 + (500 each seat)",
  },
  "2": {
    cat: "10 To 18 Passengers ",
    cost: "8, 500 + (500 each seat)",
  },
  "3": {
    cat: "19 To 24 Passengers",
    cost: "12, 500 + (500 each seat)",
  },
  "4": {
    cat: "25 To 41 Passengers",
    cost: "15, 000 + (500 each seat)",
  },
};
const Page = ({ params: { val } }: { params: { val: string } }) => {
  const category = "Third Party PSV Cover";
  ...
  if (!provider) {
    return (
      <div className="w-full flex-1 bg-slate-200 flex justify-center items-center flex-col  px-2 py-2 sm:px-24 sm:py-4">
        ...
        <Link
          href={"/service/psvTaxi/thirdParty/amaco"}
