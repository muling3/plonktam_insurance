...
const providers: { [k: string]: { cat: string; cost: string } } = {
  "1": {
    cat: "Below Ksh. 1M upto 15 Years",
    cost: "45, 000",
  },
  "2": {
    cat: "Below Ksh. 1M upto 16 - 20 Years",
    cost: "45, 000",
  },
  "3": {
    cat: "Above Ksh. 1M upto 15 Years",
    cost: "43, 000",
  },
  "4": {
    cat: "Above Ksh. 1M upto 16 - 20 Years",
    cost: "43, 000",
  },
};

const Page = ({ params: { val } }: { params: { val: string } }) => {
  const category = "School Bus Comprehensive Covers";
  ...
  if (!provider) {
    return (
      <div className="w-full flex-1 bg-slate-200 flex justify-center items-center flex-col  px-2 py-2 sm:px-24 sm:py-4">
        ...
        <Link
          href={"/service/schoolBuses/comprehensive/trident"}
  ...
  const handleSendEmail = async (e: FormEvent<HTMLFormElement>) => {
    ...
    const msg = `<p>Dear Admin</p></br>
                  ...
                  <ol>
                    ...
                    <li>Vehicle Value: <b>${provider.cat}</b></li>
