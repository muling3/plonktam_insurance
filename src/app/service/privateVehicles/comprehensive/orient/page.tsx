    ...
    <>
      <div className="w-full flex-1 px-2 py-2 sm:px-24 sm:py-4">
        ...
        <div className="opts w-full grid grid-cols-3 gap-3 sm:gap-16 place-items-center">
          ...
          <div className="dark:text-gray-900">Ksh. 1M To Ksh. 2M</div>
          ...
          <div className="dark:text-gray-900">Ksh. 2M To Ksh. 3M</div>
          ...
          <div className="dark:text-gray-900">Over Ksh. 3M </div>
          <div className="dark:text-gray-900">40, 000</div>
